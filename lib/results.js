...
/**
 * @typedef {Array} KickassResultGroup
 ...
 * @property {Array.<KickassResult>} list The list of KickassResult objects
 */
 ...
 * @returns {Promise<Array.<Comment>>} Promise which resolves with an array of Comment objects
 */
  getComments() {
    let self = this;
 ...
 * @returns {Promise<DetailsPage>} Promise which resolves with a DetailsPage object
 */
  getDetails() {
    let self = this;
    return new Promise(function (resolve, reject) {
 ...
 * @param {Cheerio} selector Cheerio selection representing one result row
 * @returns {KickassResult} A KickassResult object representing the torrent 
 * @memberof KickassResult
 * @static
 */
