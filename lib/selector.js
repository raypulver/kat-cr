 ...
 * @param {external:Cheerio} selector external:Cheerio selector obtained from entire webpage
 ...
 * @param {external:Cheerio} selection external:Cheerio selection obtained from selector
 ...
 * @param {external:Cheerio} selection external:Cheerio selection
 ...
 * @param {external:Cheerio} selection external:Cheerio selection representing magnet link
 ...
 * @param {external:Cheerio} selection external:Cheerio selection representing torrent link
 ...
 * @param {external:Cheerio} selection external:Cheerio selection representing link and title
 ...
 * @param {external:Cheerio} selector external:Cheerio selection obtained from selector
 ...
 * @param {external:Cheerio} selector external:Cheerio selection representing torrent creator
 ...
 * @param {external:Cheerio} selector external:Cheerio selection representing single result
 ...
 * @param {external:Cheerio} selector external:Cheerio selection representing torrent category
 ...
 * @param {external:Cheerio} selector external:Cheerio selection representing comment count
 ...
 * @param {external:Cheerio} selector external:Cheerio selection representing torrent size
 ...
 * @param {external:Cheerio} selector external:Cheerio selection representing seed count
 ...
 * @param {external:Cheerio} selector external:Cheerio selection representing leech count
