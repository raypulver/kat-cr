 ...
 * @param {Cheerio} selector Cheerio selector obtained from entire webpage
 * @returns {Cheerio} The cheerio selection representing the result summary
 ...
 * @param {Cheerio} selection Cheerio selection obtained from selector
 ...
 * @param {Cheerio} selection Cheerio selection
 ...
 * @param {Cheerio} selector Cheerio selector obtained from entire webpage
 * @returns {Cheerio} The cheerio selection representing the even rows
 */
 ...
 * @param {Cheerio} selector Cheerio selector obtained from entire webpage
 * @returns {Cheerio} The cheerio selection representing the odd rows
 */
 ...
 * @param {Cheerio} selection Cheerio selection obtained from selector
 * @returns {Cheerio} The cheerio selection representing the magnet link
 * @throws {UnexpectedResponseError} Throws if selection failed
 */
 ...
 * @param {Cheerio} selection Cheerio selection representing magnet link
 ...
 * @param {Cheerio} selection Cheerio selection obtained from selector
 * @returns {Cheerio} The cheerio selection representing the torrent link
 * @throws {UnexpectedResponseError} Throws if selection failed
 */
 ...
 * @param {Cheerio} selection Cheerio selection representing torrent link
 ...
 * @param {Cheerio} selection Cheerio selection obtained from selector
 * @returns {Cheerio} The cheerio selection representing the link and title
 * @throws {UnexpectedResponseError} Throws if selection failed
 */
 ...
 * @param {Cheerio} selection Cheerio selection representing link and title
 ...
 * @param {Cheerio} selector Cheerio selection obtained from selector
 * @returns {Cheerio} Selection representing torrent creator tag
 ...
 * @param {Cheerio} selector Cheerio selection representing torrent creator
 ...
 * @param {Cheerio} selector Cheerio selection representing single result
 ...
 * @param {Cheerio} selector Cheerio selection obtained from selector
 * @returns {Cheerio} Selection representing torrent category tag
 * @throws {UnexpectedResponseError} Throws if selection fails
 */
 ...
 * @param {Cheerio} selector Cheerio selection representing torrent category
 ...
 * @param {Cheerio} selector Cheerio selection obtained from selector
 * @returns {Cheerio} Selection representing torrent comment number
 */
 ...
 * @param {Cheerio} selector Cheerio selection representing comment count
 ...
 * @param {Cheerio} selector Cheerio selection obtained from selector
 * @returns {Cheerio} Selection representing torrent total size
 * @throws {UnexpectedResponseError} Throws if selection fails
 */
 ...
 * @param {Cheerio} selector Cheerio selection representing torrent size
 ...
 * @param {Cheerio} selector Cheerio selection obtained from selector
 * @returns {Cheerio} Selection representing torrent seed count
 * @throws {UnexpectedResponseError} Throws if selection fails
 */
 ...
 * @param {Cheerio} selector Cheerio selection representing seed count
 ...
 * @param {Cheerio} selector Cheerio selection obtained from selector
 * @returns {Cheerio} Selection representing torrent leech count
 * @throws {UnexpectedResponseError} Throws if selection fails
 */
 ...
 * @param {Cheerio} selector Cheerio selection representing leech count
