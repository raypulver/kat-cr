...
/**
 * @typedef {Object} ArgvParser~ArgvConfigItem
 * @description
...
/**
 * @typedef {Array.<ArgvParser~ArgvConfigItem>} ArgvParser~ArgvConfig
 * @description
...
/*
 * @typedef {function} ArgvParser~Parser
 * @description
 ...
 * @param {ArgvParser~ArgvConfig} config The array of possible command line options
 * @returns {ArgvParser~Parser} A function accepting an array of command line options
 */
 ...
 * @param {ArgvParser~ArgvConfig} config An array of possible switches
